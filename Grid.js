class Grid {
  ...
  constructor(_w, _h) {
    ...
    //source: https://p5js.org/reference/#/p5/userStartAudio
    ...
    for (var x = 0; x < img.width; x += 1) {
      for (var y = 0; y < img.height; y += 1) {
        ...
        if (state == 0) { // if pixel is black (ie there is movement)
          ...
          // play a note whenever we find movement
          // select the specific note depending on the position of the movement ont he screen
          this.synth.play(["A", "B", "C", "D", "E", "F", "G"][i % 7] + j);
        }
      }
    }
  }
